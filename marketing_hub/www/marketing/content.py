...
Handles asset library and template management for Marketing Hub portal
"""
...
def get_asset(name):
	...
	asset = frappe.get_doc("Content Asset", name)
...
def get_template(name):
	...
	template = frappe.get_doc("Marketing Template", name)
...
def upload_file(file, asset_name=None, asset_type=None, channel=None):
	...
	This is called after Frappe's file upload completes
	"""
