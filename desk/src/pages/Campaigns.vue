  ...
  <div class="flex h-full flex-col overflow-auto bg-white">
    <div class="flex-1 px-5 py-5 sm:px-6 lg:px-8">
      ...
      <div>
        ...
        <p class="mt-1 text-sm text-gray-600">Manage your marketing initiatives</p>
      </div>
      ...
      <div v-for="campaign in campaigns" :key="campaign.name" class="campaign-card">
        ...
        <div class="grid grid-cols-3 gap-2 text-sm">
          <div>
            ...
            <div class="font-semibold">{{ formatCurrency(campaign.spend) }}</div>
          </div>
          <div>
            <div class="text-gray-500">Revenue</div>
            <div class="font-semibold">{{ formatCurrency(campaign.revenue) }}</div>
          </div>
          <div>
            ...
            <div
              class="font-semibold"
              :class="{
                'text-green-600': campaign.roas >= 2,
                'text-orange-600': campaign.roas >= 1 && campaign.roas < 2,
              }"
            >
